...
# Form implementation generated from reading ui file 'c:\Users\suakb\supi\bionluk\çiftlik takip (bionluk tuba hanım)\AnaSayfa.ui'
#
...
class Ui_Anasayfa_MainWindow(object):
    def setupUi(self, Anasayfa_MainWindow):
        ...
        Anasayfa_MainWindow.resize(1109, 605)
...
"}")
        ...
        self.rzvNo_lineEdit.setInputMethodHints(QtCore.Qt.ImhNone)
        self.rzvNo_lineEdit.setInputMask("")
        ...
        self.QrOkut_pushButton = QtWidgets.QPushButton(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.QrOkut_pushButton.sizePolicy().hasHeightForWidth())
        self.QrOkut_pushButton.setSizePolicy(sizePolicy)
        self.QrOkut_pushButton.setMinimumSize(QtCore.QSize(100, 0))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        self.QrOkut_pushButton.setFont(font)
        self.QrOkut_pushButton.setStyleSheet("background-color:rgb(145, 196, 65)")
        self.QrOkut_pushButton.setObjectName("QrOkut_pushButton")
        self.horizontalLayout_6.addWidget(self.QrOkut_pushButton)
...
"Hayvanları Listele"))
        ...
        self.QrOkut_pushButton.setText(_translate("Anasayfa_MainWindow", "QR OKUT"))
